...
SPECS = [
    ...
    SpriteSpec(
        ...
        accessory="bow",
        tone="short navy bob Umi companion",
    ),
    SpriteSpec(
        "tianze",
        "Tianze",
        Path("public/portraits/tianze.png"),
        hair=0xD64A4F,
        skin=0xEFB88F,
        outfit=0x17171C,
        accent=0xD83A45,
        ...
        accessory="headband",
        tone="playful pressure-test transfer",
    ),
    SpriteSpec(
        "ichinose",
        "Ichinose",
        Path("public/portraits/ichinose.png"),
        hair=0xF07FAF,
        skin=0xEFB894,
        outfit=0x20304F,
        accent=0xD84F8F,
        ...
        accessory="folder",
        tone="pink-haired soft dominion strategist",
    ),
    SpriteSpec(
        "mahiru",
        "Mahiru",
    ...
    SpriteSpec(
        "maomao",
        "Maomao",
        Path("public/portraits/maomao.png"),
        hair=0x173B32,
        skin=0xE8B68F,
        outfit=0x181425,
        accent=0x2F8A62,
        ...
        shoe=0x101316,
        hair_style="messy",
        outfit_style="green_uniform",
        accessory="notebook",
        tone="deadpan diagnostic oddball",
    ),
    SpriteSpec(
        "sakiko",
        "Sakiko",
        Path("public/portraits/sakiko.png"),
        hair=0x37235F,
        skin=0xE8B993,
        outfit=0x181425,
        accent=0x6B5BD6,
        ...
        shoe=0x2B2145,
        hair_style="soft_long",
        outfit_style="purple_uniform",
        accessory="folder",
        tone="broken stage heiress",
    ),
]
...
def write_report() -> None:
    ...
    rows.extend(
        [
            ...
            "- Maomao and Sakiko need extra simplification because their readable traits are small silhouette + herb/notebook and purple stage-heiress posture + score folder.",
            "",
            "## Replacement Notes",
            "",
