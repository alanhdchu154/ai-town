...
export default function Home() {
  ...
  return (
    <main className="relative flex h-[100dvh] min-h-[100dvh] overflow-hidden flex-col items-center justify-between font-body game-background">
      <div className="w-full h-[100dvh] min-h-0 relative isolate overflow-hidden p-2 lg:p-3 flex flex-col justify-center items-center gap-3">
