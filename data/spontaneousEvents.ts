...
export const SPONTANEOUS_EVENTS: ReadonlyArray<SpontaneousEventSource> = [
  ...
  },
  {
    ...
    involvedNames: ['Liu Bei', 'CaoCao'],
    angleZh: '劉備會先蹲下去一起收，曹操會留意有沒有人趁亂被笑。',
  },
  {
    titleZh: '一隻貓跑進了中央庭院',
  ...
  },
  {
    ...
    angleZh: '海會先確認大家沒事，曹操會把這當成一個該被記下的小異常。',
  },
  {
    titleZh: '有人帶了一盒分不完的點心',
    descriptionZh: '有人帶了一大盒點心，明顯一個人吃不完，放在桌上猶豫著要不要開口分給別人。',
    locationId: 'aiClubRoom',
    involvedNames: ['Liu Bei', 'Mahiru'],
    angleZh: '劉備會直接招呼大家一起吃，真晝會注意那個不好意思開口的人。',
  },
  {
    titleZh: '操場傳來不知道誰在練球的聲音',
    descriptionZh: '放學後操場那邊一直傳來拍球的聲音，規律又有點固執，像是有人在練到不想停。',
    locationId: 'courtyard',
    involvedNames: ['Tianze', 'CaoCao'],
    angleZh: '天澤會好奇那個人在跟什麼較勁，曹操會想那是不是某種不說出口的壓力。',
  },
  {
  ...
  },
  {
    ...
    involvedNames: ['Mahiru', 'Liu Bei'],
    angleZh: '真晝會留意誰被風吵到、誰其實在等人陪，劉備會順手一起收。',
  },
];
