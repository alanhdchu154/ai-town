...
export const DAILY_LIFE_BULLETIN_ROTATIONS: ReadonlyArray<ReadonlyArray<DailyLifeBulletinSource>> = [
  [
    ...
    },
    {
      ...
      descriptionZh: '午餐時，祥子把湯匙放回托盤的聲音太輕，像是在避免任何人注意她停頓；海把這件事記進今天的簡報。',
      angleZh: '祥子會把裂縫藏進禮貌，海會提醒 Alan 不要把關心變成任務。',
    },
    {
      period: 'afterSchool',
      periodZh: '放學後',
      ...
      descriptionZh: '放學後，中央庭院窗邊有杯茶一直沒被碰過；一之瀨假裝沒看見，貓貓卻把杯口、水位和停頓都記進小本子。',
  ...
  [
    ...
    },
    {
      ...
      descriptionZh: '午餐時，有人把最後一塊炸雞分給隔壁桌；祥子笑著道謝，手卻把曲譜夾得更緊，一之瀨則小聲吐槽這種善意也會欠人情。',
