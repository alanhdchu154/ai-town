...
export const DAILY_LIFE_BULLETIN_ROTATIONS: ReadonlyArray<ReadonlyArray<DailyLifeBulletinSource>> = [
  [
    ...
    },
    {
      period: 'lunch',
      periodZh: '午餐',
      titleZh: '社團桌邊多了一張沒署名的練習單',
      locationId: 'aiClubRoom',
      involvedNames: ['Sakiko', 'Umi'],
      descriptionZh: '午間自由活動時，社團桌邊多了一張沒署名的練習單；祥子把它壓在曲譜底下，海只在簡報上標了一句：有人不想被點名。',
      angleZh: '祥子會把裂縫藏進禮貌，海會提醒 Alan 先看人，不要急著追原因。',
    },
    {
      period: 'afterSchool',
      periodZh: '放學後',
      ...
      involvedNames: ['Ichinose', 'Maomao'],
      descriptionZh: '放學後，中央庭院窗邊有張椅子被挪得比平常遠；一之瀨假裝沒看見，貓貓卻把距離、腳步和停頓都記進小本子。',
      angleZh: '一之瀨會戳破表面的沒看見，貓貓會在意那句沒事是不是症狀。',
    },
    {
      period: 'evening',
      periodZh: '晚上',
      titleZh: '宿舍門口多了一張借物便條',
      locationId: 'dormitory',
      involvedNames: ['Mahiru', 'Umi'],
      descriptionZh: '晚上，宿舍門口多了一張沒署名的借物便條；真晝沒有追問是誰寫的，海只提醒大家先別把每個停頓都變成任務。',
  ...
  [
    {
      ...
      descriptionZh: '早晨點名時，有位學生回答慢了半拍；海沒有立刻追問，只在簡報上標了一個小記號，貓貓則看見班上幾個人同時轉頭。',
      angleZh: '海會減少壓力，貓貓會觀察誰的「沒事」先露出症狀。',
    },
    {
      period: 'lunch',
      periodZh: '午餐',
      titleZh: '社團桌上多了一張活動傳單',
      locationId: 'aiClubRoom',
      involvedNames: ['Sakiko', 'Ichinose'],
      descriptionZh: '午間自由活動時，社團桌上多了一張活動傳單；祥子笑著說可以幫忙收，一之瀨則小聲吐槽這種善意也會欠人情。',
      angleZh: '祥子會把不安藏進禮貌，一之瀨會看見善意裡的邊界。',
    },
    {
      period: 'afterSchool',
      periodZh: '放學後',
      ...
      descriptionZh: '放學後，黑板角落還留著一道小考錯題；天澤把題目往前推半步，真晝則問那位學生要不要把錯題留到明天一起看。',
      angleZh: '天澤會測理解破綻，真晝會先確認對方是不是被錯題困住。',
    },
    {
      period: 'evening',
      periodZh: '晚上',
  ...
  [
    ...
    },
    {
      ...
      descriptionZh: '午間自由活動時，有本社團筆記被放到錯的桌上；海順手放回去，天澤卻笑著問：如果大家都假裝沒看見，錯位是不是就會變成規則。',
    ...
    },
    {
      ...
      locationId: 'courtyard',
      involvedNames: ['Ichinose', 'Sakiko'],
      descriptionZh: '放學後，庭院有人反覆練習一句沒說完的話；一之瀨沒有插手，祥子只把曲譜翻回第一頁，像是在準備重新上台。',
      angleZh: '一之瀨會守住不要代說，祥子會用禮貌把裂縫暫時收起來。',
    },
    {
      period: 'evening',
      periodZh: '晚上',
      titleZh: '宿舍有人沒有回晚安',
      locationId: 'dormitory',
      involvedNames: ['Mahiru', 'Maomao'],
      descriptionZh: '晚上，宿舍有人沒有回晚安；真晝留意到那扇門後太安靜，貓貓則把走廊聲音放輕，免得大家假裝沒發生。',
      angleZh: '真晝會留在附近，貓貓會讓走廊不要變成壓力。',
    },
  ],
];
