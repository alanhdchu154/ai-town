...
README under `docs/paper/results/ablation-*`. Forced co-location is not the main
...
python3 scripts/paper/power_sensitivity.py \
    --outdir docs/paper/results/power
```

**Longitudinal collection:** see `docs/paper/LONGITUDINAL_EXPERIMENT_PLAN.md`.
...
- Keep the conservative arXiv source (`docs/paper/arxiv/main.tex`) aligned with
