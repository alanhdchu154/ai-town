...
- source: `docs/paper/emotional-residue/manuscript/main.tex`
- archive: `docs/paper/emotional-residue/results/arxiv-source/emotional-residue-arxiv-source.tar.gz`
- manifest: `docs/paper/emotional-residue/results/arxiv-source/manifest.json`
- archive SHA-256:
...
`docs/paper/emotional-residue/release/SUBMISSION_DECISIONS.json` only after Alan explicitly confirms.
...
2. Replace the author placeholder in `docs/paper/emotional-residue/manuscript/main.tex`.
...
6. Fill `docs/paper/emotional-residue/release/PDF_VERIFICATION.json` with real render details and PDF
   SHA-256.
7. Rerun:
