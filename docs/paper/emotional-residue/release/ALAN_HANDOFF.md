...
- A-path release packet:
  `docs/paper/emotional-residue/release/ARXIV_PREPRINT_RELEASE_PACKET.md`
- OSF release record:
  `docs/paper/emotional-residue/release/OSF_RELEASE_RECORD.md`
- Citation provenance is tracked in `docs/paper/emotional-residue/claims/CITATION_PROVENANCE.md`; it
...
- Outside release status: Alan reported an OSF submission; public OSF URL / DOI
  ...
  `docs/paper/emotional-residue/results/osf/emotional-residue-osf-preprint.pdf`. arXiv is not
  posted because endorsement is still required.
- No new long-window cloud collection should run until
  `docs/paper/emotional-residue/experiments/SCHEDULE_DECISION.md` and
  `docs/paper/emotional-residue/experiments/PREREGISTRATION_PROTOCOL.md` are accepted by Alan.
...
- OSF: submitted by Alan on 2026-06-10; public URL / DOI still need to be
  recorded in `docs/paper/emotional-residue/release/OSF_RELEASE_RECORD.md`.
...
- `docs/paper/emotional-residue/release/PDF_VERIFICATION.json` must remain false/blank until the rendered
...
- explicit Alan acceptance of `docs/paper/emotional-residue/experiments/SCHEDULE_DECISION.md`;
- explicit Alan acceptance of `docs/paper/emotional-residue/experiments/PREREGISTRATION_PROTOCOL.md`;
- matching accepted JSON gates in `docs/paper/emotional-residue/experiments/SCHEDULE_ACCEPTANCE.json` and
...
`docs/paper/emotional-residue/results/arxiv-source/emotional-residue-arxiv-source.tar.gz`
