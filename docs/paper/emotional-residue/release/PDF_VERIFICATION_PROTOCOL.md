...
Fill `docs/paper/emotional-residue/release/PDF_VERIFICATION.json` only after all of the following are
actually true:
...
- The rendered source archive SHA-256 matches the current
  `docs/paper/emotional-residue/results/arxiv-source/manifest.json` archive hash.
- The rendered PDF SHA-256 is recorded.

## JSON Contract

`docs/paper/emotional-residue/release/PDF_VERIFICATION.json` is the local record. Required fields:
