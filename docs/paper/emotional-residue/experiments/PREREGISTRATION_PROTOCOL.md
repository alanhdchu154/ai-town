...
does not authorize collection; both `docs/paper/emotional-residue/experiments/SCHEDULE_ACCEPTANCE.json` and
`docs/paper/emotional-residue/experiments/PREREGISTRATION_ACCEPTANCE.json` must be accepted before the
