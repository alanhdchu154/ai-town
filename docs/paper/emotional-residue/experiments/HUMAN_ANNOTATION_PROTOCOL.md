...
Use `docs/paper/emotional-residue/experiments/annotations_template.csv` as the starting schema:
...
python3 scripts/paper/merge_rater_annotations.py \
  ...
  --rater raterA=docs/paper/emotional-residue/results/longitudinal/raterA_completed.csv \
  --rater raterB=docs/paper/emotional-residue/results/longitudinal/raterB_completed.csv \
  --out docs/paper/emotional-residue/results/longitudinal/annotations.csv \
  --manifest docs/paper/emotional-residue/results/longitudinal/annotations_manifest.json
```
...
python3 scripts/paper/export_annotation_sheet.py \
  ...
  --target 30 \
  --manifest docs/paper/emotional-residue/results/longitudinal/annotation_packet_manifest.json
```
...
python3 scripts/paper/export_blinded_transcripts.py \
  ...
  --manifest docs/paper/emotional-residue/results/longitudinal/blinded_transcripts/transcript_packet_manifest.json
```
...
python scripts/paper/analyze.py \
  --dataset docs/paper/emotional-residue/results/longitudinal/dataset.json \
  --annotations docs/paper/emotional-residue/results/longitudinal/annotations.csv \
