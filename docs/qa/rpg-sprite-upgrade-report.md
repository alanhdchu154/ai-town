...
| Umi | `public/portraits/umi.png` | `public/sprites/umi.png` | short navy bob Umi companion; hair `#151c3a`, outfit `#d8dee8`, accent `#2f66b2` |
| Tianze | `public/portraits/tianze.png` | `public/sprites/tianze.png` | playful pressure-test transfer; hair `#d64a4f`, outfit `#17171c`, accent `#d83a45` |
| Ichinose | `public/portraits/ichinose.png` | `public/sprites/ichinose.png` | pink-haired soft dominion strategist; hair `#f07faf`, outfit `#20304f`, accent `#d84f8f` |
